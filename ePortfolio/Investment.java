...
abstract class Investment {
    ...
    */
    ...
    protected Investment(){/*declaration*/}

    protected Investment(Investment copy) {
        this.type = copy.type;
     ...
     */
    protected Investment(String type, String symbol, String name, double bookValue, double price, int quantity) {
        this.type = type;
        this.symbol = symbol;
        this.name = name;
        this.price = price;
    ...
    public String toStringScreen(){
        return "<html>type = \"" + this.type + "\"<br>symbol = \"" + this.symbol + "\"<br>name = \"" +  this.name + "\"<br>quantity = \"" + this.quantity + "\"<br>price = \"" + this.price  + "\"<br>bookValue = \"" + this.bookValue + "\"<br></html>";
    }
}
